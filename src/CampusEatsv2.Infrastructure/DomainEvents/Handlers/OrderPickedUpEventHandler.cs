...
public sealed class OrderPickedUpDomainEventHandler
    : INotificationHandler<OrderPickedUpDomainEvent>
{
    private readonly AppDbContext _context;
    private readonly IEventBus _eventBus;

    public OrderPickedUpDomainEventHandler(
    ...
    public async Task Handle(
        OrderPickedUpDomainEvent notification,
