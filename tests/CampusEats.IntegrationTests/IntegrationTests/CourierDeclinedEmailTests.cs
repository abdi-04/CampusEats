...
using CampusEats.IntegrationTests.Helper;
using NUnit.Framework;

namespace CampusEats.IntegrationTests;
...
public class CourierDeclinedEmailTests
{
    ...
    [Test]
    public async Task CourierDeclined_Sends_Declined_Email()
    {
        IntegrationTestPublisher.PublishIntegrationEvent(
            routingKey: "courier.declined",
            payload: new {
