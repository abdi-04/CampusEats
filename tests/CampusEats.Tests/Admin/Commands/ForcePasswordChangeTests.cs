...
public class ForcePasswordChangeTests
{
    ...
    // - Helper 
    private async Task<CampusEats.Core.Models.Admin> CreateAdmin(bool isFirstLogin)
    {
        var hasher = new PasswordHasher<CampusEats.Core.Models.Admin>();
        var admin = new CampusEats.Core.Models.Admin
        {
            AdminId = Guid.NewGuid(),
            //FullName = "Test Admin",
            Email = "admin@example.com",
            PasswordHash = hasher.HashPassword(new CampusEats.Core.Models.Admin { Email = "admin@example.com", PasswordHash = "" }, "oldpassword123"),
